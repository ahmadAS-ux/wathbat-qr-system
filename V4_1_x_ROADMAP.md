...
**Last updated:** May 2026 (after v4.1.5 ship)
**Current production version:** v4.1.5
...
3. ~~**v4.1.5** — Multi-file Replace button~~ ✅ shipped
...
|---|---|---|
| v4.1.5 | Current production | n/a (this is current) |
| v4.1.4 | Pre-v4.1.5 (no multi-file Replace) | `git reset --hard v4.1.4` then force-push |
